...
<styles>
  ...
  <border>
    <left color="Color" size="Size" style="BorderStyle" />
    <right color="Color" size="Size" style="BorderStyle" />
    <top color="Color" size="Size" style="BorderStyle" />
    <bottom color="Color" size="Size" style="BorderStyle" />
  </border>
  <font size="Size" family="String" />
  <color value="Color" />
</styles>
```
