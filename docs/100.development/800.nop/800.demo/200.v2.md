...
```xml {8,24} title="nop-demo-delta/src/main/resources/_vfs/_delta/v2/nop/demo/pages/control.xlib"
<?xml version="1.0" encoding="UTF-8" ?>
<lib xmlns:x="/nop/schema/xdsl.xdef"
      x:schema="/nop/schema/xlib.xdef"
      x:extends="/nop/web/xlib/control.xlib">
...
需要注意的是，扩展的 `edit-tree-parent` 不需要重复声明参数
`attr`，其直接复用原定义。但 `c:script` 和 `tree-select/source/url`
均需要重写一遍，二者不能被复用。
