  ...
  },
  {
    ...
    description: (
      <>
        ...
        本平台将提供适用于各类业务需求的前后端一体的功能组件，
        并可支持组件市场，让组件生态繁荣成长，从而为二次开发提供更加便捷和稳定的生态环境。
      </>
    ),
  },
  {
    ...
    description: (
      <>
        本平台致力于为各类企业提供先进的数字基础平台，为开发者提供便捷、稳定的开发平台，
        让数字基础更好、更快、更稳地为社会生产力和生产效率而服务，让开发人员的潜力得到完全释放。
      </>
    ),
  },
];
