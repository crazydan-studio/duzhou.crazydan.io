...
const features = [
  {
    ...
    description: (
      <>
        以最为前沿和先进的软件构造理论 — &nbsp;
        <a href="https://zhuanlan.zhihu.com/p/64004026">可逆计算</a>
        为核心指导思想，进行平台的功能设计与技术实现，
        打造出<b>可持续演进</b>的二次开发平台，
        积极主动地适应新时代、新环境的业务开发需求。
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        本平台将提供适用于各类业务需求的<b>前后端一体</b>的功能组件，
        并推动和发展组件市场，让各类组件快速生长，从而为二次开发提供更加繁荣和稳定的生态环境。
      </>
    ),
  },
  {
    ...
    description: (
      <>
        本平台致力于为各类企业提供先进的数字基础平台，为开发者提供便捷、稳定、高效的开发平台，
        让数字基础更好、更快、更稳地为社会生产力和生产效率服务，让开发人员的潜力得到完全释放。
      </>
    ),
  },
];
